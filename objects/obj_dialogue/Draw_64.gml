// Draw the box
draw_set_alpha(0.7)
draw_rectangle_color(x, y, width+x, height+y, c_black, c_black, c_blue, c_blue, false);
draw_rectangle_color(x, y, width+x, height+y, c_white, c_white, c_white, c_white, true);
draw_set_alpha(1)
...
if (finished && option_count > 0) {
	...
	for (var i = 0; i < option_count; i++) {
		...
		draw_set_alpha(0.5)
		draw_rectangle_color(opt_x, opt_y - option_height / 2, option_width+opt_x, option_height+opt_y, c_black, c_black, c_blue, c_blue, false);
		draw_set_alpha(1)
