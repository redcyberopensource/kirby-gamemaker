...
switch global.powerup
{
	...
	case 6:
		spr_fall_default = spr_kirb_ninja_fall;
		spr_jump_default = spr_kirb_ninja_jump;
		spr_idle_default = spr_kirb_ninja_idle;
		spr_walk_default = spr_kirb_ninja_walk;
		spr_run_default = spr_kirb_ninja_run;
		spr_float_default = spr_kirb_ninja_float;
		spr_float_idle_default = spr_kirb_ninja_float_idle;
		spr_float_halt_default = spr_kirb_ninja_float_halt;
	break;
	
	case 7:
		spr_fall_default = spr_kirb_v_fall;
		spr_jump_default = spr_kirb_v_jump;
		spr_idle_default = spr_kirb_v_idle;
		spr_walk_default = spr_kirb_v_walk;
		spr_run_default = spr_kirb_v_run;
		spr_float_default = spr_kirby_v_float;
	...
	case 9:
		spr_fall_default = spr_kirb_ufo;
		spr_jump_default = spr_kirb_ufo;
		spr_idle_default = spr_kirb_ufo;
		spr_walk_default = spr_kirb_ufo;
		spr_run_default = spr_kirb_ufo;
		spr_float_default = spr_kirb_ufo;
		spr_float_idle_default = spr_kirb_ufo;
		spr_float_halt_default = spr_kirb_ufo;
	break;
}
}